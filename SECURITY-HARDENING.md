...
#### F31. groundRules Rule 10 is self-override escape hatch — DEFERRED
**File:** `groundRules.md:48`
"If following a rule would genuinely harm the user's goal, explain why you're deviating" — tells both Sonnet and Haiku that rules can be overridden. **Deferred**: Will be addressed in a full groundRules review.
